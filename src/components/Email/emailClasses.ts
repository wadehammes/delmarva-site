...
export const emailClasses = {
  ...
  bullet: "m-0 p-0 text-sm leading-6 text-delmarva-text",
  bulletLast: "mb-6 mt-0 p-0 text-sm leading-6 text-delmarva-text",
  button:
    "box-border block w-full rounded bg-delmarva-red px-6 py-4 text-center text-sm font-semibold leading-6 text-white no-underline",
  ...
  content: "my-4",
  footerText: "m-0 text-center text-sm leading-6 text-delmarva-muted",
  footerWrapper: "mt-10 pt-0",
  heading: "m-0 mb-5 p-0 text-center text-xl font-bold leading-7 text-white",
  hr: "mx-0 my-6 w-full",
  label:
    "m-0 mb-2 mt-6 p-0 text-xs font-semibold uppercase leading-5 tracking-wide text-delmarva-muted",
  labelFirst:
    "m-0 mb-2 mt-0 p-0 text-xs font-semibold uppercase leading-5 tracking-wide text-delmarva-muted",
  link: "text-delmarva-red underline",
  muted: "m-0 mb-0 p-0 text-sm leading-6 text-delmarva-muted italic",
  paragraph: "mb-6 p-0 text-sm leading-6 text-delmarva-text",
