...
import { AreasServicedMapLoadingOverlay } from "./AreasServicedMapLoadingOverlay.component";
...
interface AreasServicedMapProps {
...
export const AreasServicedMap = (props: AreasServicedMapProps) => {
  const {
    services,
    className,
